        ...
        <header className="sticky top-0 z-50 backdrop-blur-md bg-white/80 dark:bg-slate-950/80 border-b border-slate-200 dark:border-slate-800/60 shadow-sm transition-colors text-left">
            ...
            {isDrawerOpen && (
                <div className="fixed inset-0 z-50 md:hidden">
                    ...
                    {/* Drawer Panel */}
                    <div className="fixed bottom-0 left-0 right-0 bg-slate-900 border-t border-slate-800 rounded-t-2xl shadow-2xl p-4 sm:p-6 space-y-4 max-h-[90vh] overflow-y-auto animate-slide-up z-50">
                        {/* Header */}
